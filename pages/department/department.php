    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #01377D">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/coursesystem/pages/department/department.php" class="nav-link active">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <td>" . $row["department_status"] . "</td>"; // Added this line to display department_status

                        // Display button for Edit and Delete
                        echo "<td>
                <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modal-edit' data-department-id='" . $row['department_id'] . "' data-department='" . $row['department_course'] . "'>
                    <i class='fas fa-edit'></i>
                </button>
                <button type='button' class='btn btn-danger' onclick='confirmDelete(" . $row['department_id'] . ")'>
                    <i class='fas fa-trash'></i>
                        ...
                        if ($row["department_status"] == 'Active') {
                          echo "<button class='btn btn-success' onclick='deactivateDepartment(" . $row['department_id'] . ")'>Active</button>";
                        } else {
                          echo "<button class='btn btn-danger' onclick='activateDepartment(" . $row['department_id'] . ")'>Deactivated</button>";
                        }
                        echo "</td></tr>";
                      }
                    } else {
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="department_course" name="department_course" required>
              </div>
            </div>
            <div class="modal-footer">
