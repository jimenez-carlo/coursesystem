       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/coursesystem/pages/transaction/confirmation/confirmation.php" class="nav-link active">
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="font-weight: bold;">Confirmation</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="input-group input-group-sm" style="width: 150px;">
                            ...
                            <!-- Modal to display victim details -->
<div class="modal" id="witnessModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body" id="victimDetails">
                    <!-- Victim details will be displayed here -->
                </div>
...
// Fetch data from confirmation_tbl
$sql = "SELECT * FROM confirmation_tbl";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>" . $row["student_block"] . "</td>
                <td>" . $row["student_name"] . "</td>
                <td>" . $row["student_status"] . "</td>
                
                <td><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modal-edit' onclick='openEditModal(" . $row['admin_id'] . ")'>Edit</button></td>";
  ...
  swal({
            ...
            if (willDelete) {
                ...
                swal("Poof! Curriculum has been deleted!", {
                    ...
                    window.location.href = 'delete_curriculum.php?department_id=' + codeId;
                });
            } else {
