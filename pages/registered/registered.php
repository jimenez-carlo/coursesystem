        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="../../educational_program/curriculum/curriculum.php" class="nav-link active">
...
$sql = "SELECT * FROM curriculum_tbl";
        ...
        <div class="modal-content">
            ...
            <form action="add_curriculum.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="curriculum_course" class="font-weight-bold">Department Course:</label>
                        <select class="form-control" id="curriculum-course" name="curriculum_course" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="editdepartment.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="curriculum_year">Curriculum Year:</label>
                        <input type="number" class="form-control" id="curriculum_year" name="curriculum_year" value="<?php echo $curriculum_year; ?>" required>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
