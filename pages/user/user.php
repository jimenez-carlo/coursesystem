...
<div class="modal" id="userModal">
    ...
    <tbody>
    <?php
// Assuming you have executed the database query and stored the result in $result
// Include your database connection and execute the query
include('../../conn.php');

// Fetch data from user_tbl
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                <td><img src='data:image/jpeg;base64," . base64_encode($row["user_profile"]) . "' alt='User Profile' style='max-width: 50px; max-height: 50px;'></td>
                ...
                <td>
                    <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modal-edit' onclick='openEditModal(" . $row['user_id'] . ")'>
                        <i class='fas fa-edit'></i>
                    </button>
                    <button type='button' class='btn btn-danger' onclick='confirmDelete(" . $row['user_id'] . ")'>
    ...
    // If no rows are returned, you can display a message here
            ...
            <form action="add_user.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_firstname" name="user_firstname" placeholder="First Name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="user_lastname" name="user_lastname" placeholder="Last Name" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" class="form-control" id="user_age" name="user_age" placeholder="Age" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="tel" class="form-control" id="user_mobile" name="user_mobile" placeholder="Mobile Number" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="user_profile" class="btn btn-primary btn-block">
                            Choose Profile Picture
                            <input type="file" id="user_profile" name="user_profile" accept="image/*" style="display: none;" required>
                        </label>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form action="edit_user.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="user_profile" name="user_profile" accept="image/*">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (logoutLink) {
    ...
    // Script to handle opening the edit modal and passing the user_id
    $(document).ready(function() {
    $('#modal-edit').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget); // Button that triggered the modal
        var userId = button.data('user-id'); // Extract department_id from data-attribute
        var modal = $(this);
        modal.find('.modal-body #user_id').val(userId); // Set the user_id in the modal form
    });
});
