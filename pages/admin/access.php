                ...
                <?php foreach (get_list("SELECT * from access_tbl") as $row) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST">
                        <input required type="hidden" name="id" value="<?= $row['access_id'] ?>">
                    ...
                    <td>
                      <form method="POST">
                        <input required type="hidden" name="delete" value="<?= $row['access_id'] ?>">
                        <button type='button' class='btn btn-sm btn-warning button-edit' data-toggle="tooltip" title="Edit" data-id='<?= $row['access_id'] ?>' data-url='edit_role'>
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="form-group">
              ...
              <input required type="text" class="form-control" id="access_role" name="access_role" required>
            </div>
          </div>
