                ...
                <?php foreach (get_list("SELECT * from class_type_tbl") as $row) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST">
                        <input type="hidden" name="id" value="<?= $row['class_type_id'] ?>">
                    ...
                    <td>
                      <form method="POST">
                        <input type="hidden" name="delete" value="<?= $row['class_type_id'] ?>">
                        <button type='button' class='btn btn-sm btn-warning button-edit' data-id='<?= $row['class_type_id'] ?>' data-url='edit_class_type'>
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="class_type_name" name="class_type_name" required>
            </div>
          </div>
