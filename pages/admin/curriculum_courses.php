          ...
          <div class="form-group">
            <div class="form-group">
              ...
              <select name="subject_id" id="subject_id" class="form-control">
                <?php foreach (get_list("SELECT cc.*,s.* from subject_tbl s inner join class_type_tbl cc on cc.class_type_id = s.class_type_id where s.deleted_flag = 0 and s.subject_id not in (select subject_id from curriculum_subjects_tbl where curriculum_id = " . $_GET['id'] . ")") as $row) { ?>
