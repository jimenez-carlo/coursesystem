                ...
                <?php foreach (get_list("SELECT * from semester_tbl") as $row) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST">
                        <input required type="hidden" name="id" value="<?= $row['semester_id'] ?>">
                    ...
                    <td>
                      <form method="POST">
                        <input required type="hidden" name="delete" value="<?= $row['semester_id'] ?>">
                        <button type='button' class='btn btn-sm btn-warning button-edit' data-toggle="tooltip" title="Edit" data-id='<?= $row['semester_id'] ?>' data-url='edit_semester'>
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="form-group">
              ...
              <input required type="text" class="form-control" id="semester_name" name="semester_name" required>
            </div>
          </div>
