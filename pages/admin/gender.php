                ...
                <?php foreach (get_list("SELECT * from gender_tbl") as $row) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST">
                        <input type="hidden" name="id" value="<?= $row['gender_id'] ?>">
                    ...
                    <td>
                      <form method="POST">
                        <input type="hidden" name="delete" value="<?= $row['gender_id'] ?>">
                        <button type='button' class='btn btn-sm btn-warning button-edit' data-id='<?= $row['gender_id'] ?>' data-url='edit_gender'>
