...
$data = get_one("select * from civil_status_tbl where civil_status_id = " . $_GET['id']);
?>
<div class="modal-header bg-primary text-white">
  <div class="row w-100 justify-content-between align-items-center">
    <div class="col">
      <h4 class="modal-title">Edit Civil Status Name</h4>
    </div>
    <div class="col-auto">
    </div>
  </div>
...
<form method="POST" enctype="multipart/form-data">
  ...
  <input type="hidden" name="id" value="<?= $data->civil_status_id ?>">
