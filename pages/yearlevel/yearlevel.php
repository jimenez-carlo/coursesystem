    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/coursesystem/pages/yearlevel/yearlevel.php" class="nav-link active">
              <i class="nav-icon fas fa-building"></i>
              <p>
                Year Level
              </p>
            ...
            <div class="card-header">
                <div class="row align-items-center">
                    ...
                    <div class="input-group input-group-sm" style="width: 150px;">
                            ...
                            <!-- Modal to display YEAR LEVEL details -->
<div class="modal" id="yearlevelModal">
        <div class="modal-dialog">
            <div class="modal-content">

                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Year Level Details</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <!-- Modal Body -->
                <div class="modal-body" id="yearlevelDetails">
                    <!-- year level details will be displayed here -->
                </div>
...
// Fetch data from year_levels_tbl
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                <td>" . $row["year_year"] . "</td>
                <td>" . $row["yearlevel_status"] . "</td>"; // Added this line to display yearlevel_status

        // Display button for Edit and Delete
        echo "<td>
                <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modal-edit' data-year-id='" . $row['year_id'] . "'>
                    <i class='fas fa-edit'></i>
                </button>
                <button type='button' class='btn btn-danger' onclick='confirmDelete(" . $row['year_id'] . ")'>
        ...
        echo "<td>";
        if ($row["yearlevel_status"] == 'Active') {
            echo "<button class='btn btn-success' onclick='deactivateDepartment(" . $row['year_id'] . ")'>Active</button>";
        } else {
            echo "<button class='btn btn-danger' onclick='activateDepartment(" . $row['year_id'] . ")'>Deactivated</button>";
        }
        echo "</td></tr>";
    }
} else {
...
<div class="modal fade" id="modal-add" tabindex="-1" role="dialog" aria-labelledby="modal-add-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="add_yearlevel.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" name="year_id">
                    <div class="form-group">
                    <div class="form-group">
                        <label for="year-year" class="font-weight-bold">Year Level:</label>
                        <select class="form-control" id="year-year" name="year_year" required>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="modal-edit-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="edit_yearlevel.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" id="year_id" name="year_id"> <!-- Ensure this gets populated when opening modal -->

                    <div class="form-group">
                        <label for="year-level" class="font-weight-bold">Year Levels:</label>
                        <select class="form-control" id="year_year" name="year_year" required>
                            <option value="">Select Year Level</option>
                            <option value="1st Year">1st Year</option>
                            <option value="2nd Year">2nd Year</option>
                            <option value="3rd Year">3rd Year</option>
        ...
        swal({
            ...
            if (willDelete) {
                ...
                swal("Poof! Department has been deleted!", {
                    ...
                    window.location.href = 'delete_yearlevel.php?year_id=' + yearId;
                });
            } else {
                swal("Year Level is safe!");
...
$(document).ready(function() {
    $('#modal-edit').on('show.bs.modal', function(event) {
        ...
        var yearId = button.data('year-id'); // Extract department_id from data-attribute
        var modal = $(this);
        modal.find('.modal-body #year_id').val(yearId); // Set the department_id in the modal form
    });
});

    function deactivateDepartment(yearId) {
        ...
        if (confirm("Are you sure you want to deactivate this department?")) {
            ...
            window.location.href = 'deactivate_yearlevel.php?id=' + yearId;
        }
    }

    function activateDepartment(yearId) {
        ...
        if (confirm("Are you sure you want to activate this department?")) {
            ...
            window.location.href = 'activate_yearlevel.php?id=' + yearId;
        }
    }
       ...
       $(document).ready(function() {
            ...
            $('#searchResults').on('click', 'li', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $('#yearleveltDetails').html(response);
                    }
                });
            });
        });
