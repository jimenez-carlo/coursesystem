...
<div class="user-panel mt-3 pb-3 mb-3 d-flex">
    ...
    <div class="info">
        <a href="#" class="d-block">zeyn</a>
        <span style="color: yellow">Super Admin</span>
    </div>
</div>

      <!-- Sidebar Menu -->
      <li class="nav-item">
            <a href="../../final_index.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    $sql = "SELECT COUNT(*) as totalUsers FROM user_tbl";
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <div class="icon">
                        <i class="ion ion-person"></i> <!-- You can change the icon as needed -->
                    </div>
