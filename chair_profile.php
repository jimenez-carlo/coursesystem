...
<head>
    ...
    <title>Profile</title>
    <link rel="stylesheet" href="/css/chair_profile.css">
...
<body>
    <header class="header">
        ...
        <nav class="profile">
            <a href="chair_profile.php" class="active"><i class="bi bi-person"></i></a>
                ...
                <div class="form-container">
                    <form action="#" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="telephoneNo" name="telephoneNo" readonly>
                        </div>
