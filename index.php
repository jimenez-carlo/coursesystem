...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $check_email_query = "SELECT admin_email as `user_name`,admin_id as `user_id`,admin_password as `user_password`,access_id FROM admin_tbl WHERE admin_email = ? UNION SELECT student_email as `user_name`,student_id as `user_id`,student_password as `user_password`,access_id FROM student_tbl WHERE student_email =  ?";
